...
import YouthUnionTable from "./YouthUnionTable";
import { CustomFieldset } from "@aq-fe/core-ui/shared/components/layout/CustomFieldset";
import { useCustomReactQuery } from "@aq-fe/core-ui/shared/hooks/useCustomReactQuery";

export default function YouthUnionTableContainer() {
    ...
    const Q_Standard = useCustomReactQuery({
        queryKey: ["YouthUnionTableContainer", "Standard", "GetAll"],
        axiosFn: () => service_standard.getAll(),
    });

    return (
        <CustomFieldset title="Lập kế hoạch năm mới - Đoàn hội">
            <Stack gap="xs">
                <Tabs>
                    <Tabs.List>
                ...
                <YouthUnionTable standardId={standandSelect[0]} setFixedActivityPointRatio={setFixedActivityPointRatio} />
            </Stack>
        </CustomFieldset>
    );
}
