...
import MandatoryActivityInfo from "./TabGeneralInfo/MandatoryActivityInfo";
...
export default function MandatoryActivityCreateUpdateModal({ futurePlanId, values, loadingActionIcon }: Props) {
                ...
                <Stack>
                    <Tabs
                        ...
                        <Tabs.Panel value="info" mih="66vh">
                            <MandatoryActivityInfo disclosure={disc} form={form} isUpdate={isUpdate} />
                        </Tabs.Panel>
