...
export default function MandatoryActivitiesGenerateQR({ eventValue }: { eventValue: IMandatoryActivitiesEventInfoViewModel }) {
    ...
    return (
        <Group>
            <CustomButtonModal
                ...
                disclosure={disc}
            >
                <Text mt="md" fw={500}>Điều:{eventValue.standardCode}</Text>
                <CustomHtmlWrapper html={eventValue.name!} />

                <Text mt="md" fw={500}>Đơn vị tổ chức: {eventValue.hostName}</Text>
