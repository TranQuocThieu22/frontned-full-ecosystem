...
export default function StudentAffairsGenerateQR({ eventValue }: { eventValue: IStudentAffairsParticipationEventInfoViewModel }) {
    const EXPIREDTIME = 30; // seconds
    ...
    return (
        <Group>
            <CustomButtonModal
                ...
                disclosure={disc}
            >
                <Text fw={500}>Điều: {eventValue.standardCode}</Text>
                <CustomHtmlWrapper html={eventValue.name!} />

                <Text fw={500}>Đơn vị tổ chức: {eventValue.hostName}</Text>
