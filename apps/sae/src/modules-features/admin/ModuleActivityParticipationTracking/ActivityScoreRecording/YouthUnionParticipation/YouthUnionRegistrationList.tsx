...
export default function YouthUnionRegistrationList({ eventValue, iconType = "number" }: { eventValue: Event, iconType?: IconType }) {
  ...
  if (studentEventQuery.isError) return "Error loading data";

  const originalData = Array.isArray(studentEventQuery.data) ? studentEventQuery.data : [];
