...
import MessageLoadingComponent from "./MessageLoadingComponent";
...
export default function ChatWithAIMessageBox({ typingRef }: MessageBoxComponetProps) {
    ...
    return (
        <div style={{ flex: 1, minHeight: 0, overflow: 'auto' }}>
            <Stack>
                ...
                <MessageLoadingComponent bgDotColor="#999" ref={typingRef} />
                <div ref={scrollRef} />
            </Stack>
        </div>
    );
