...
export default function MyBoxesBackground({ title = "Hệ thống thông tin quản lí tài sản", desc = "Được phát triển bởi công ty công nghệ Anh Quân." }: { title?: string, desc?: string }) {
    return (
