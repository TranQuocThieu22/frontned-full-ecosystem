...
import F4_2DeleteTransferDetailsTab1 from "./F4_2DeleteTransferDetailsTab1";
...
export default function F4_2ReadTransferDetailsTab1() {
    ...
    const query = useQuery<I_Detail_List[]>({
        queryKey: ["F4_2detailListDataTab1"], // Khóa cache
        queryFn: async () => {
            return mockData
        }
    });
        ...
        <MyDataTable
                ...
                <>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            queryClient.setQueryData<I_Detail_List[]>([`F4_2detailListDataTab1`], [...query.data!, newRecord]);
                        }}
                    >
                        Thêm
                    </Button>
            ...
            renderRowActions={({ row }) => (
                <MyCenterFull>
                    ...
                    <F4_2DeleteTransferDetailsTab1 id={row.original.id!} />
                </MyCenterFull>
            )}
        />
    );
