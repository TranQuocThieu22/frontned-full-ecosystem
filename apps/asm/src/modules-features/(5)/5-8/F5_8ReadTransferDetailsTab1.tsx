...
import F5_8DeleteTransferDetailsTab1 from "./F5_8DeleteTransferDetailsTab1";
...
export default function F5_8ReadTransferDetailsTab1() {
    ...
    const query = useQuery<I_Detail_List[]>({
        queryKey: ["F5_8detailListDataTab1"], // Khóa cache
        queryFn: async () => {
            return mockData
        }
    });
        ...
        <MyDataTable
                ...
                <>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            queryClient.setQueryData<I_Detail_List[]>([`F5_8detailListDataTab1`], [...query.data!, newRecord]);
                        }}
                    >
                        Thêm
                    </Button>
            ...
            renderRowActions={({ row }) => (
                <MyCenterFull>
                    ...
                    <F5_8DeleteTransferDetailsTab1 id={row.original.id!} />
                </MyCenterFull>
            )}
        />
    );
