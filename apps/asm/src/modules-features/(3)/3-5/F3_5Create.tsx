...
interface ICreateAssetBuyingPlan {
    code?: string;
    name?: string;
...
export default function F3_5Create() {
    const form = useForm<ICreateAssetBuyingPlan>({
        initialValues: {
            code: "",
            name: "",
    ...
    const assetSelectTableData = useQuery<IAssetOfSelectTable[]>({
        queryKey: [`F3_5AssetOfSelectTable_create`],
        queryFn: async () => {
