'use client'
import { ActionIcon, Blockquote, Divider, FileInput, Indicator, MantineProvider, Modal, Paper, SimpleGrid, Space, Switch, Table, TextInput, Textarea, Title, Tooltip, createTheme } from '@mantine/core';
import { DateInput, MonthPickerInput, TimeInput } from '@mantine/dates';
