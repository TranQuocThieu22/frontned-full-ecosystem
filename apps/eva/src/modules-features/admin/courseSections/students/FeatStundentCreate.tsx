...
export default function FeatStundentCreate() {
    ...
    useEffect(() => {
        if (mockStudentEnrollments.length > 0) {
            const firstStudent = mockStudentEnrollments[0];
            handleStudentSelect(firstStudent?.id.toString()!);
        }
    }, []);
