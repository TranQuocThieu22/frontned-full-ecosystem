...
import { MyActionIconModal, MyButton, MyNumberInput, MyTextInput } from "aq-fe-framework/components";
...
export default function AttachedSurveyFormUpdate({ values }: { values: IAttachedSurveyFormInfoViewModel }) {
  ...
  return (
    <MyActionIconModal  disclosure={disc} crudType="update" onSubmit={(values) => console.log(values)}>
      <MySelect
        data={selectTenPhieu}
        label="Tên mẫu phiếu"
