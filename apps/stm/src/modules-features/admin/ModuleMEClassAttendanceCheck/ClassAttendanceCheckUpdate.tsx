import { Badge, Center, Checkbox, Select } from "@mantine/core";
...
import { renderSelectOption, statusMap, statusOptions } from "./StatusMap";
    ...
    const columns = useMemo<MRT_ColumnDef<I_AttendanceTable>[]>(() => [
        ...
        },
        {
            ...
            Cell: ({ row }) =>
                <Center>
                    <Checkbox
                        checked={editedData[row.index]?.notifiedParent}
                        onChange={(e) => {
                            const newData = [...editedData];
