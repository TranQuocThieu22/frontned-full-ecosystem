...
import { MyDateInput, MyFileInput, MySelect, MyTextArea, MyTextInput } from "aq-fe-framework/components";
import { useEffect } from "react";

export interface I_pcsestxdlb_SwapCourseRead {
    maHocVien?: string;
    tenHocVien?: string;
    gioiTinh?: string;
    ngaySinh?: string;
...
export default function F_pcsestxdlb_SwapCourseRead() {
    const disc = useDisclosure();
    const form = useForm<I_pcsestxdlb_SwapCourseRead>({
        initialValues: {
            maHocVien: "HV02589",
    ...
    return (
        <MyButtonCreate
            objectName="Chi tiết chuyển khóa"
            disclosure={disc}
            modalSize="50%"
            label="Chuyển khóa học"
