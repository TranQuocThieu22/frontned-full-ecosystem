...
export default function F_kfjughenth_Update({ data }: { data: Ikfjughenth }) {
    const disc = useDisclosure(false);
    const form = useForm<Ikfjughenth>({
        initialValues: {
            ...data,
        },
        validate: {
    ...
    return (
        ...
        >
            ...
            />
            {(data.loaiQuyetDinh == "Chuyển khóa học" || data.loaiQuyetDinh == "Nhập học lại") && (
                <MySelect
