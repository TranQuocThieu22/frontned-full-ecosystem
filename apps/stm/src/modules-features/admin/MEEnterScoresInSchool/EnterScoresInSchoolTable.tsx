...
export default function EnterScoresInSchoolTable() {
    ...
    const columns = useMemo<MRT_ColumnDef<ClassInfo>[]>(
        () => [
            ...
            },
            {
                ...
                size: 200,
                Cell: ({ row }) => <DisplayClassStatus classStatus={DisplayClassStatusMap[row.original.status] ?? 0} />
            },
            {
        ...
        <>
            <Group mb={10}>
                <MySelect
                    clearable={false}
                    label="Chọn học kỳ"
                    defaultValue={"Học kỳ 1 - 2024-2025"}
                    data={["Học kỳ 1 - 2024-2025", "Học kỳ 2 - 2024-2025", "Học kỳ 1 - 2025-2026", "Học kỳ 2 - 2025-2026"]}
                />
            </Group>
