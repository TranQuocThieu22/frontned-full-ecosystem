...
import { Box, Flex, Group, NumberFormatter, NumberInput, Paper, Text, Title } from "@mantine/core";
import { MyNumberFormatter } from "aq-fe-framework/components";
import { CustomNumberInput } from "aq-fe-framework/core";
        ...
        >
          ...
          <Box w={{ base: '100%', sm: 'auto' }}>
            <Flex align="center" gap="md">
              ...
              <Text fw={500} w={100} inline c="red">
                <NumberFormatter suffix="đ" value={tuitionFee} thousandSeparator />
              </Text>
            </Flex>
            <Flex align="center" gap="md" mt="md">
