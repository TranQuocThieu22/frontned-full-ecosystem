...
import { Checkbox, Fieldset, Group, ScrollArea, Select, SimpleGrid } from "@mantine/core";
    ...
    const getSelectedBranches = (): IBranchDiscount[] => {
        ...
        return branchQuery.data
            .filter(branch => {
                ...
                const isSelected = form.values[branch.code as keyof typeof form.values] === true;
        ...
        <Group>
            <MyButtonCreate
                ...
                onSubmit={async (value) => {
                    ...
                    baseAxios.post("/Discount/Create", cleanedData)
                    await utils_notification_show({ crudType: 'create' })
                    await disc[1].close()
                }}>
                <MyFlexColumn>
                    <SimpleGrid cols={{ base: 1, xs: 2, md: 2 }}>
                        <MyTextInput label="Mã chiết khấu" {...form.getInputProps("code")} />
                        <Select
