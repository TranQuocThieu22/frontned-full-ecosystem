...
function formatDataFinal({ pass12MonthData }: { pass12MonthData: IPast12MonthsAgoStudentQuantity }) {
    const result: { month: string; Quantity?: number }[] = [];
    const now = new Date();

    const keys: (keyof IPast12MonthsAgoStudentQuantity)[] = [
        "twelfthMonthAgoQuantity",
        "evelenthMonthAgoQuantity",
        "tenthMonthAgoQuantity",
        "ninthMonthAgoQuantity",
        "eighthMonthAgoQuantity",
        "seventhMonthAgoQuantity",
        "sixthMonthAgoQuantity",
        "fifthMonthAgoQuantity",
        "fourthMonthAgoQuantity",
        "thirdMonthAgoQuantity",
        "secondMonthAgoQuantity",
        "firstMonthAgoQuantity",
...
export default function LineChart_TotalStudentIn12Months({ pass12MonthData }: { pass12MonthData: IPast12MonthsAgoStudentQuantity }) {
        ...
        <>
            <Group>
                ...
                <LineChart
                    ...
                    dataKey="month"
                    series={[
                        { name: 'Quantity', color: 'rgba(64, 65, 135, 1)' },
                    ]}
                    tooltipProps={{
