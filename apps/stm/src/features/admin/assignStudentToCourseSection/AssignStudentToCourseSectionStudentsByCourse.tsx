...
import AssignStudentToCourseSectionDeleteFromCourse from './AssignStudentToCourseSectionDeleteFromCourse';
...
export default function AssignStudentToCourseSectionStudentsByCourse({ label, values, color }: IBase) {
    const disc = useDisclosure()

    const danhSachLop = useQuery<IEnrollment[]>({
        queryKey: [`AssignStudentToCourseSectionStudentsByCourse`, values],
        queryFn: async () => {
            const body = {
                ...
                <CustomDataTable
                    ...
                    renderRowActions={({ row }) => (
                        <Center>
                            ...
                            <AssignStudentToCourseSectionDeleteFromCourse data={row.original} />
                        </Center>
                    )}
                />
            </CustomButtonModal>
