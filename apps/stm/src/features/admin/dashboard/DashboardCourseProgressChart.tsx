    ...
    return (
        <Paper px="md" py="sm" withBorder shadow="md" radius="md">
            ...
            {payload.map((item: any) => (
                <Text key={item.name} c={"black"} fz="sm">Tiến độ: {item.value}%</Text>
            ))}
        </Paper>
    );
}
...
export default function DashboardCourseProgressChart({ courseProcessData }: { courseProcessData?: ICourseProcess[] }) {
