...
export default function DashboardExamStatusChart({
    ...
    const data = [
        ...
        { course_status: 'Đã cấp chứng chỉ', amount: isCertificatedAmound, color: 'orange.6' },
    ];
