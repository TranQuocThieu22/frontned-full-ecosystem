...
export default function F_6zq8o5gd8o_Update({ values }: { values: I_6zq8o5gd8o }) {
    ...
    return (
        <MyActionIconUpdate title="Chi tiết giảm giá cá nhân" modalSize="60%" form={form} onSubmit={() => { }}>
            <Grid>
                <Grid.Col span={6}>
