...
export default function F_05tb8fc3wi_Create() {
    ...
    return (
        <>
            <MyButtonCreate
                ...
                onSubmit={() => { }}
                form={form}
                objectName="combo khuyến mãi"
            >
                <MyTextInput label="Tên combo khuyến mãi" {...form.getInputProps("comboName")} />
                            ...
                            <Fieldset legend="Mức ưu đãi">
                                <Flex align="center" direction="row" gap="xs">
                                    ...
                                    <NumberInput
                                        ...
                                        hideControls
                                    />
                                    <Text> sản phẩm để được giảm </Text>
                                    <NumberInput
                            ...
                            <Fieldset legend="Mức ưu đãi">
                                <Flex align="center" direction="row" gap="xs">
                                    ...
                                    <NumberInput
                                        ...
                                        hideControls
                                    />
                                    <Text> sản phẩm chỉ với giá </Text>
                                    <NumberInput
                                        {...form.getInputProps("discountAmount")}
                                        min={0}
                                        hideControls
