...
export default function DiscountType1SearchTable(
    { allDiscountData, discSearchDiscountTable, selectedDiscount, setSelectedDiscount }:
        { allDiscountData: DiscountViewModel[], discSearchDiscountTable: any, selectedDiscount?: DiscountViewModel, setSelectedDiscount: any }
) {
    ...
    const DiscountSelectMRTColumns = useMemo<MRT_ColumnDef<DiscountViewModel>[]>(() => [
        {
            header: "Mã giảm giá",
            accessorKey: "code",
        },
    ...
    const DiscountSelectMRT = useMantineReactTable({
        ...
        state: { rowSelection },
        getRowId: (originalRow: DiscountViewModel) => originalRow.id!.toString(),
        initialState: {
            density: "md",
