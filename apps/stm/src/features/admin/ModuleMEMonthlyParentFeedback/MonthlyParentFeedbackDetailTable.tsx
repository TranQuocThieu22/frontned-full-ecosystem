...
export default function MonthlyParentFeedbackDetailTable() {
    ...
    const columns = useMemo<MRT_ColumnDef<IStudentReport>[]>(() => [
        ...
        { header: "SĐT Phụ huynh", accessorKey: "parentPhone" },
        {
            ...
            id: "status",
            size: 250,
            accessorFn: row => <Center><StudentStatusBadge result={StudentStatusMap[row.status || -1] ?? 0} /></Center>
        },
        ...
        { header: "Nội dung GV góp ý", accessorKey: "teacherNote" },
        {
            ...
            id: "qcApproval",
            size: 250,
            accessorFn: row => <Center><QLCLStatusBadge result={QLCLStatusMap[row.qcApproval || -1] ?? 0} /></Center>
        },
