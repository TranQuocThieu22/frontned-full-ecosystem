...
export default function ViewDetailResultRow({
  ...
  const columns = useMemo<
    MRT_ColumnDef<IReport>[]
  >(
    () => [
      { header: "Mã tiêu chí", accessorKey: "eaqTaskDetail.eaqAnalysis.eaqLimitation.eaqCriteria.code" },
      {
        header: "Tên tiêu chí",
        accessorKey: "eaqTaskDetail.eaqAnalysis.eaqLimitation.eaqCriteria.name",
        size: columnSizeObject.name,
      },
      { header: "Mã hạn chế", accessorKey: "eaqTaskDetail.eaqAnalysis.eaqLimitation.code" },
