...
import EvidenceVersionsUpdate from "./EvidenceVersionUpdateModal";
...
interface EvidenceVersionTabProps {
  evidenceId?: number;
  readOnly?: boolean;
...
export default function EvidenceVersionTable({
  ...
  return (
    <CustomDataTable<IEnvidenceVersion>
      ...
      {...(!readOnly && {
        ...
        renderRowActions: ({ row }) => (
          <CustomCenterFull>
            <EvidenceVersionsUpdate values={row.original} onUpdate={handleUpdate} />
