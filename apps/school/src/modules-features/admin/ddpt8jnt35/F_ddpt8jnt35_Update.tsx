...
import { I_ddpt8jnt35 } from './F_ddpt8jnt35_Read';
import { useEffect } from 'react';

export default function F_ddpt8jnt35_Update({ data }: { data: I_ddpt8jnt35 }) {
    ...
    return (
        <MyActionIconUpdate modalSize={"40%"} form={form} onSubmit={() => { }} title='Chi tiết đăng ký suất ăn'>
           <MySelect
                label="Học sinh"
                withAsterisk
