...
export default function F_core26965_Create() {
    ...
    return (
        <MyButtonCreate objectName="Văn bản quy định tổ chức" form={form} onSubmit={async (values) => {
            ...
            <F11_3SelectDocumentType label="Loại văn bản" documentTypeId={OBJECT_DOCUMENT_TYPES.Regulations} {...form.getInputProps("documentAttributeId")} />
