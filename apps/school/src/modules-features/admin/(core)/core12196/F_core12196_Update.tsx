...
export default function F_core12196_Update({ values }: { values: I }) {
    ...
    return (
        <MyActionIconUpdate form={form} onSubmit={async (values) => {
            ...
            <F12_1Select label="Loại văn bản" documentTypeId={OBJECT_DOCUMENT_TYPES.Form} {...form.getInputProps("documentAttributeId")} />
