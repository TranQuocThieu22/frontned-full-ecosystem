...
import { MyButtonCreate, MyCheckbox, MyDateInput, MyNumberInput, MySelect, MyTextArea, MyTextInput } from "aq-fe-framework/components"

interface Ixbx2dluzw4_CreateDSVatTuToChucSK {
    maSuKien: string;
    tenSuKien: string;
    ngayToChuc: Date;
    vatTu: string;
...
export default function F_xbx2dluzw4_Create() {
    //===initiate===
    const form = useForm<Ixbx2dluzw4_CreateDSVatTuToChucSK>({
        initialValues: {
            maSuKien: '',
            tenSuKien: '',
            ngayToChuc: new Date(),
    ...
    return(
        <MyButtonCreate onSubmit={()=>{}} form={form}>
            ...
            <MyDateInput label='Ngày hoàn thành' {...form.getInputProps("ngayHoanThanh")}/>
