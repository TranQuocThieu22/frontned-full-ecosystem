...
export default function F_hbwyvjoqgu_CreatePickUp() {
    ...
    return (
        <MyButtonModal label={"Thêm lượt đón"} modalSize={1000} crudType={"create"} title='Chi tiết lịch trình xe' onSubmit={() => { } } disclosure={dis} >
