...
import ToolsMenuButton from "../ChatAQNewSolution/components/ToolsMenuButton";
import { ChatBotStore_AddMessage, ChatBotStore_ResetSession, MessageContent } from "./stores/ChatAdmissionStore";

interface FormComponetProps {
    typingRef: RefObject<{ updateLoading: (loading: boolean) => void }>,
}

export default function ChatBotAdmissionForm({ typingRef }: FormComponetProps) {
    ...
    const mutation = useMutation({
        mutationFn: async (value: MessageContent) => {
            ...
            form.reset();
            return await axios.post("https://vp.aqtech.edu.vn/CoreApiChat/ask-admission-chat", {
