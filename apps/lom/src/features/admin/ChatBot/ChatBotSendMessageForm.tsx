...
interface FormComponetProps {
    typingRef: RefObject<{ updateLoading: (loading: boolean) => void } | null>,
}

export default function ChatBotSendMessageForm({ typingRef }: FormComponetProps) {
    ...
    const mutation = useMutation({
        mutationFn: async (value: MessageContent) => {
            ...
            form.reset();
            return await axios.post("https://vp.aqtech.edu.vn/CoreApiChat/ask-lom-solution-chat", {
