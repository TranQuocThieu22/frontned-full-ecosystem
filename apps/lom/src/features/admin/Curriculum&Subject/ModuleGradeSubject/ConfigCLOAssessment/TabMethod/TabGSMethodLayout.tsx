...
import { ASSESSMENT_QUESTION_TYPE } from "@/data/enum/global"
...
export default function TabGSMethodLayout({ isActiveTab, gradeSubjectId }: { isActiveTab: boolean, gradeSubjectId?: number }) {
