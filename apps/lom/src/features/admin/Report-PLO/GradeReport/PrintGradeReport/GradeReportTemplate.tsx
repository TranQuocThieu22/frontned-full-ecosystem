...
export interface GradeReportTemplateProps {
    desciption?: string
    date?: Date;
    studentName?: string
    dateOfBirth?: Date
...
export default function GradeReportTemplate(props: GradeReportTemplateProps) {
    return (
        <CustomFlexColumn>
            ...
            <CustomFlexEnd>
                <CustomFlexColumn>
                    <Text ta={"center"}>{formatVietnameseDate(props.date || new Date())}</Text>
