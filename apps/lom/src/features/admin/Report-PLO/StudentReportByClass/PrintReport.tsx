...
export default function PrintReport({ disabled, PLOdata, reportData, programInfo, gradeInfo, classInfo }: IPrintReportProps) {
    return (
        ...
        >
            ...
            <CustomFlexColumn mt={18} gap={6}>
                <Group>
                    <Text>Lớp: {classInfo.name ?? "Không có dữ liệu"}</Text>
