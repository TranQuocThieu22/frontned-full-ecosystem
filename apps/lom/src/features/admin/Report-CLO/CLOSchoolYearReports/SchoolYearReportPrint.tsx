            ...
            <CustomButtonPrintPDF buttonProps={{
                ...
                <CustomFlexColumn p={'lg'} style={{ fontFamily: '"Times New Roman", Times, serif' }}>
                    ...
                    <CustomFlexColumn ta={'center'} gap={2}>
                        ...
                        <Text fw={'bold'} tt={"uppercase"} fs={"normal"}>{selectedSchoolYear.name} </Text>
                    </CustomFlexColumn>
                    <CustomFlexRow>
