            ...
            {payload.map((item: any, index) => (
                <React.Fragment key={index}>
                    <Text key={index} c={"black"} fz="sm">
                        {item.name === 'totalCOEGradeSubject' ? 'Số lượng môn học' : 'Số lượng môn học cốt lõi'}: {item.value}
                    </Text>
                </React.Fragment>
            ))}
        </Paper>
...
export default function HBarChart_totalCOEGradeSubjectsAndPIsPerGrade() {
    ...
    return (
        <Group>
            ...
            <BarChart
                ...
                series={[
                    { name: 'totalCOEGradeSubject', color: 'blue.6', label: 'Số lượng môn học' },
                    { name: 'totalCOECoreGradeSubject', color: 'red.6', label: 'Số lượng môn học cốt lõi' },
                ]}
                barProps={{
                    label: {
                        position: 'right',
