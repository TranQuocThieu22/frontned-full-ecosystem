...
const data = [
    { name: 'Đạt CLO', value: 12900, color: "#fecf16" },
    { name: 'Không đạt CLO', value: 8900, color: "#eb5f1a" },
...
export function Piechart_PercentageStudentPassPLO() {
    // const totalDisountCode = mockData.reduce((acc, cur) => acc + cur.used, 0);
    return (
        <>
            <Text mb={"20"}>Biểu đồ theo dõi tỷ lệ sinh viên đạt chuẩn đầu ra môn học cốt lõi trong học kỳ hiện tại</Text>
            <Grid>
