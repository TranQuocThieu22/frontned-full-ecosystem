...
import F9_4_4UpdateComplicationProgressButtonModal from "./F9_4_4UpdateComplicationProgressButtonModal";
import { mockDataRead } from "./mockData";
export interface IF9_4_4ReadUpdateComplicationProgress {
...
export default function F9_4_4ReadUpdateComplicationProgress(){
    const query = useQuery<IF9_4_4ReadUpdateComplicationProgress[]>({
        queryKey: ['F9_4_4UpdateComplicationProgress'],
        queryFn: async ()=> mockDataRead
    });
    const columns = useMemo<MRT_ColumnDef<IF9_4_4ReadUpdateComplicationProgress>[]>(
        () => [
            {
                header: "Mã kế hoạch",
        ...
        <MyFieldset title="Danh sách kế hoạch">
            <MyDataTable
                ...
                renderRowActions={({ row }) => (
                    <MyCenterFull>
                      <F9_4_4UpdateComplicationProgressButtonModal/>
                    </MyCenterFull>
                )}
            />
        </MyFieldset>
