...
import { MyButtonCreate, MyCheckbox, MyFieldset, MyFileInput, MySelect, MyTextInput } from 'aq-fe-framework/components';
...
export default function CurriculumSyllabusProposalsCreate() {
