...
import { MyActionIconUpdate, MyDataTable, MyDateInput, MyFileInput, MyTextArea, MyTextInput } from "aq-fe-framework/components";
import { MRT_ColumnDef } from "mantine-react-table";
import { useMemo } from "react";
import { ApprovedProposal, CurriculumApprovalDecision } from "./ApproveProposalLayout";

export default function ApproveProposalUpdate({ values }: { values: CurriculumApprovalDecision }) {
