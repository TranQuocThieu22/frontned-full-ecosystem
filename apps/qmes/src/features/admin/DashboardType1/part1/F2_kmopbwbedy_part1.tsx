...
export default function F2_kmopbwbedy_part1() {
    ...
    // 1
    const [opened11, set11Opened] = useState(false);
    const [opened12, set12Opened] = useState(false);
    const [opened13, set13Opened] = useState(false);
    const [opened14, set14Opened] = useState(false);


    const [openedChart11, handlers11] = useDisclosure(false);
    const [openedChart12, handlers12] = useDisclosure(false);
    const [openedChart13, handlers13] = useDisclosure(false);
    const [openedChart14, handlers14] = useDisclosure(false);
        ...
        <>
            ...
            <MyFlexRow>
                <Group>
                    ...
                    <IconAddressBook color="blue" />

                    <Text size="xl">1. Tổ chức và quản trị</Text>
