...
export default function F2_kmopbwbedy_part1() {
    ...
    const [opened31, set31Opened] = useState(false);
    const [opened321, set321Opened] = useState(false);
    const [opened322, set322Opened] = useState(false);
    const [opened331, set331Opened] = useState(false);
    const [opened332, set332Opened] = useState(false);
    const [opened341, set341Opened] = useState(false);
    const [opened342, set342Opened] = useState(false);

    const [openedChart31, handlers31] = useDisclosure(false);
    const [openedChart321, handlers321] = useDisclosure(false);
    const [openedChart322, handlers322] = useDisclosure(false);
    const [openedChart331, handlers331] = useDisclosure(false);
    const [openedChart332, handlers332] = useDisclosure(false);
    const [openedChart341, handlers341] = useDisclosure(false);
    const [openedChart342, handlers342] = useDisclosure(false);
    ...
    const questionList: I_list[] = [

        {
            ...
            ...defaultItem,
            id: 9,
            title: "3.2.1 Diện tích sàn xây dựng phục vụ đào tạo (tối thiểu 2.8m2)",
        ...
        <>
            ...
            <MyFlexRow>
                <Group>
                    ...
                    <IconBuilding color="blue" />

                    <Text size="xl">3. Cơ sở vật chất</Text>
