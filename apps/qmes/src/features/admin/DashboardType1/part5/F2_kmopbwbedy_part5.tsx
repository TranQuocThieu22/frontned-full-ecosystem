...
import { defaultItem, I_list } from "../F2_kmopbwbedy_Read";
import F2_kmopbwbedy_displayData from "../F2_kmopbwbedy_displayData";
export default function F2_kmopbwbedy_part1() {

    const [opened511, set511Opened] = useState(false);
    const [opened512, set512Opened] = useState(false);
    const [opened521, set521Opened] = useState(false);
    const [opened522, set522Opened] = useState(false);
    const [opened531, set531Opened] = useState(false);
    const [opened532, set532Opened] = useState(false);
    const [opened541, set541Opened] = useState(false);
    const [opened542, set542Opened] = useState(false);
    const [opened55, set55Opened] = useState(false);


    const [openedChart511, handlers511] = useDisclosure(false);
    const [openedChart512, handlers512] = useDisclosure(false);
    const [openedChart521, handlers521] = useDisclosure(false);
    const [openedChart522, handlers522] = useDisclosure(false);
    const [openedChart531, handlers531] = useDisclosure(false);
    const [openedChart532, handlers532] = useDisclosure(false);
    const [openedChart541, handlers541] = useDisclosure(false);
    const [openedChart542, handlers542] = useDisclosure(false);
    const [openedChart55, handlers55] = useDisclosure(false);
        ...
        <>
            ...
            <MyFlexRow>
                <Group>
                    ...
                    <Text size="xl">5. Tuyển sinh và đào tạo</Text>
