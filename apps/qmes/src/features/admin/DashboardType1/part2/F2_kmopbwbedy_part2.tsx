...
export default function F2_kmopbwbedy_part1() {
    ...
    const [opened21, set21Opened] = useState(false);
    const [opened22, set22Opened] = useState(false);
    const [opened23, set23Opened] = useState(false);

    const [openedChart21, handlers21] = useDisclosure(false);
    const [openedChart22, handlers22] = useDisclosure(false);
    const [openedChart23, handlers23] = useDisclosure(false);
        ...
        <>
            <MyFlexRow>
                <Group>
                    ...
                    <Text size="xl">2. Giảng viên</Text>
