...
import { MyCardioLoader } from "aq-fe-framework/components";
import { MyBoxesCore } from "./MyBoxes";

// Default values shown

export default function MyBoxesBackground({
    title = "Quản lý đo lường và đánh giá tiêu chuẩn cơ sở giáo dục",
    desc = "Được phát triển bởi công ty công nghệ Anh Quân." }
    :
