"use client";
import { MySwitchTheme } from "@/components/ui/ActionIcons/SwitchTheme/MySwitchTheme";
import { MyAppSpotlight } from "@/components/ui/AppSpotlight/MyAppSpotlight";
import F0Logout from "@/features/auth/F0Logout/F0Logout";
        ...
        <>
            {items.map((item, index) => (
                <NavLink
                    ...
                    label={<MyFlexRow justify={"space-between"}>{item.label} {getRightSection(item.status!)}</MyFlexRow>}
                    childrenOffset={28}
