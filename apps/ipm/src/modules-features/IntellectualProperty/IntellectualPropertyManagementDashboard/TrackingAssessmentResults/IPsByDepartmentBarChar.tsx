...
const data = [
    { khoa: 'Khoa CNTT', soLuongIP: 60 },
    { khoa: 'Khoa Y', soLuongIP: 45 },
    { khoa: 'Khoa kỹ thuật', soLuongIP: 40 },
];


export default function IPsByDepartmentBarChar() {
    return (
        <>
            <Text fw={500} mb={10}>Số lượng IP theo khoa</Text>
