...
interface Ir9uv5mc0rlViewModalNotDone {
...
const mockData: Ir9uv5mc0rlViewModalNotDone[] = [
...
export default function F_r9uv5mc0rl_Read() {
    ...
    const studentListQuery = useQuery<Ir9uv5mc0rlViewModalNotDone[]>({
    ...
    const columnsNotDone = useMemo<MRT_ColumnDef<Ir9uv5mc0rlViewModalNotDone>[]>(() => [
    ...
    return (
        ...
        <MyDataTable
            enableRowSelection columns={columnsNotDone}
            data={studentListQuery.data!}
            renderTopToolbarCustomActions={() =>
                <Group> <MyButton crudType='save' /></Group>
