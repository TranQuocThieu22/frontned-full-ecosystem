...
export default function F_neyukerymr_Update({ data }: { data: F_neyukerymr_Update }) {
    const form = useForm<F_neyukerymr_Update>({
        initialValues: data
    })

    // Sử dụng useQuery để lấy dữ liệu
    const query = useQuery<ITable_neyukerymr_Create[]>({
        queryKey: ["sinhVienData_neyukerymr"], // Khóa cache dữ liệu
        queryFn: async () => [
