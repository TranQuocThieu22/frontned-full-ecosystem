...
interface IProgressBysofaqgcmfhIdViewModel {
    id?: number;
...
const mockData: IProgressBysofaqgcmfhIdViewModel[] = [
    {
        id: 1,
...
const mockData2: IProgressBysofaqgcmfhIdViewModel[] = [
    {
        id: 5,
...
interface IsofaqgcmfhInfoViewModel {
    id?: number;
    code?: string;
    name?: string;
    gender?: string;
...
const mockData3: IsofaqgcmfhInfoViewModel = {
    id: 1,
    code: "SV001",
    name: "Nguyễn Văn A",
    gender: "Nam",
...
export default function F_sofaqgcmfh_ReadByIdButton(
    { sofaqgcmfhId }: { sofaqgcmfhId: number }
) {

    const sofaqgcmfhInfoById = useQuery<IsofaqgcmfhInfoViewModel>({
        queryKey: [`F_sofaqgcmfhInfoById`],
        queryFn: async () => {
    ...
    const ProgressBysofaqgcmfhId = useQuery<IProgressBysofaqgcmfhIdViewModel[]>({
    ...
    const columns = useMemo<MRT_ColumnDef<IProgressBysofaqgcmfhIdViewModel>[]>(() => [
        {
            header: "Mã năm học",
        ...
        <>
            ...
            >
                <MyFlexColumn >
                    ...
                    {sofaqgcmfhInfoById.isLoading && "Đang tải dữ liệu..."}
                    {sofaqgcmfhInfoById.isError && "Lỗi khi tải dữ liệu..."}
                    <Grid>
                            ...
                            <Table
                                ...
                                <Table.Tbody>
                                    <Table.Tr>
                                        ...
                                        <Table.Td>{sofaqgcmfhInfoById.data?.name!}</Table.Td>
                                    </Table.Tr>

                                    <Table.Tr>
                                        <Table.Th>Mã sinh viên</Table.Th>
                                        <Table.Td>{sofaqgcmfhInfoById.data?.code!}</Table.Td>
                                    </Table.Tr>

                                    <Table.Tr>
                                        <Table.Th>Trạng thái</Table.Th>
                                        <Table.Td>{sofaqgcmfhInfoById.data?.studyStatus!}</Table.Td>
                                    </Table.Tr>
                                </Table.Tbody>
                            </Table>
                        </Grid.Col>
                    ...
                    {ProgressBysofaqgcmfhId.isLoading && "Đang tải dữ liệu..."}
                    {ProgressBysofaqgcmfhId.isError && "Lỗi khi tải dữ liệu..."}
                    <Fieldset
                    ...
                    >
                        <MyDataTable
                            ...
                            columns={columns}
                            data={ProgressBysofaqgcmfhId.data!}
                        />
                    </Fieldset>
                </MyFlexColumn>
            </MyButtonModal>
