...
export default function F_xkbakmsytn_Create() {
    const form = useForm<F_xkbakmsytn_Create>({
        initialValues: {
            soQuyetDinh: '',
            lyDoQuyetDinh: 'Quyết định nghỉ học',
            tenQuyetDinh: '',
            ngayQuyetDinh: null,
    ...
    return (
        <MyButtonCreate form={form} onSubmit={() => { }} objectName='Chi tiết quyết định nghỉ học' modalSize={"80%"}>
            <MyFlexRow style={{ display: 'flex', gap: '1rem', width: '100%' }}>
                ...
                <MySelect data={['Quyết định nghỉ học']} label="Lý do quyết định" {...form.getInputProps("lyDoQuyetDinh")}  style={{ flex: 1 }}/>
            </MyFlexRow>
