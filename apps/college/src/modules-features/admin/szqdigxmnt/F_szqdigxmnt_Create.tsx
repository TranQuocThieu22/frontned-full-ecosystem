...
export default function F_szqdigxmnt_Create() {
    const form = useForm<F_szqdigxmnt_Create>({
        initialValues: {
            soQuyetDinh: '',
            lyDoQuyetDinh: 'Quyết định trúng tuyển',
            tenQuyetDinh: '',
            ngayQuyetDinh: null,
        ...
        validate: {
            ...
            nguoiKy: (value) => (value ? null : 'Người kí là bắt buộc'),
    ...
    return (
        <MyButtonCreate form={form} onSubmit={() => { }} objectName='Chi tiết quyết định vào mới' modalSize={"80%"}>
