...
export default function F_dludhotzxa_Create() {
    const form = useForm<F_dludhotzxa_Create>({
        initialValues: {
            soQuyetDinh: '',
            lyDoQuyetDinh: 'Quyết định đổi lớp',
            tenQuyetDinh: '',
            ngayQuyetDinh: null,
    ...
    return (
        <MyButtonCreate form={form} onSubmit={() => { }} objectName='Chi tiết quyết định đổi lớp' modalSize={"80%"}>
        <MyFlexRow style={{ display: 'flex', gap: '1rem', width: '100%' }}>
            ...
            <MySelect data={['Quyết định đổi lớp']} label="Lý do quyết định" {...form.getInputProps("lyDoQuyetDinh")} style={{ flex: 1 }}/>
        </MyFlexRow>
