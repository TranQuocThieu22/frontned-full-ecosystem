...
export interface IF_gqurocczve_Create {
    id?: number; // STT
...
export default function F_gqurocczve_Create() {
    const form = useForm<IF_gqurocczve_Create>({
        initialValues: {
            reasonsCode: "",
            name: "",
            type: "",
    ...
    const handleSubmit = (values: IF_gqurocczve_Create) => {
