...
import F_cmhkoi90r9_Read from './F_cmhkoi90r9_Read';
...
export default function F_cmhkoi90r9_ReadModal({
    ...
    return (
        <>
            <Button bg={"green"} onClick={() => setOpened(true)}>Chọn</Button>
            <Modal size="auto"
            opened={opened} onClose={() => setOpened(false)}  centered>
                <MyFieldset mt="20"title='Danh sách nhóm thi chưa thêm vào đợt thi'>
                <MyDataTable
                    ...
                    <>
                    <MyButton crudType='default' bg={"green"}>Chọn</MyButton>
                    <AQButtonExportData
                            isAllData={true}
