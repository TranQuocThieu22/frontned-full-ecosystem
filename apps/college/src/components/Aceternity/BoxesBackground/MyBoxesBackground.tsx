...
export default function MyBoxesBackground({ title = "Hệ thống thông tin Quản lý trường Trung cấp & Cao đẳng", desc = "Được phát triển bởi công ty công nghệ Anh Quân." }: { title?: string, desc?: string }) {
    return (
