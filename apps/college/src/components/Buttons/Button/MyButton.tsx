...
import { IconDeviceFloppy, IconEdit, IconFileImport, IconPlus, IconPrinter, IconTrash, IconX } from "@tabler/icons-react";
import { ReactNode } from "react";

interface IMyButton extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "color" | "style">, ButtonProps {
    crudType?: "default" | "create" | "update" | "delete" | "save" | "createMultiple" | "check" | "import" | "print" | "cancel"
    children?: ReactNode;
}
...
export function MyButton({ children, crudType = "delete", ...rest }: IMyButton) {
    ...
    if (crudType == "save") {
        return (
            <Button color="blue" leftSection={<IconDeviceFloppy />} type="submit" {...rest}>
                {children ? children : "Lưu"}
            </Button>
        );
    }
