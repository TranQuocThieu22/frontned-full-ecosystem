...
export default function MyBoxesBackground({ title = "Hệ thống thông tin quản lí nghiên cứu khoa học", desc = "Được phát triển bởi công ty công nghệ Anh Quân." }: { title?: string, desc?: string }) {
    return (
