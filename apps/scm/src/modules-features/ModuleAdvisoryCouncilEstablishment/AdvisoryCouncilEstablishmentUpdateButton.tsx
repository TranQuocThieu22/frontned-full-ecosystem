...
import { MyActionIconUpdate, MyFlexColumn, MyFlexRow, MySelect, MyTab, MyTextArea, MyTextInput } from "aq-fe-framework/components";
...
export default function AdvisoryCouncilEstablishmentButtonUpdate({
  values,
}: {
  values: IAdvisoryCouncilEstablishment;
}) {
