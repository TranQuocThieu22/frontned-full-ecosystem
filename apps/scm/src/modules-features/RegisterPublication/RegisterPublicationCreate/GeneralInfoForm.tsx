...
import { MyFileInput, MyNumberInput, MySelect, MyTextArea, MyTextInput } from "aq-fe-framework/components";
...
export default function GeneralInfoForm() {
    const form = useForm<IGeneralInfoForm>({
        initialValues: {
            code: "",
            publicationTitle: "",
            publicationType: "",
    ...
    return (
        <form onSubmit={() => { }}>
            <SimpleGrid cols={{ base: 1, md: 2 }} >
                ...
                <Stack >
                    <MyNumberInput label="Năm xuất bản" {...form.getInputProps("publishYear")} />
                    <MyTextInput label="Số trang" {...form.getInputProps("pages")} />
