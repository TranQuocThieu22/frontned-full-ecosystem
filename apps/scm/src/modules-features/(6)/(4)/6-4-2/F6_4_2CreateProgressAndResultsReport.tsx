...
export default function F6_4_2CreateProgressAndResultsReport() {
    ...
    return (
        <MyButtonCreate objectName="Báo cáo tiến độ và kết quả thực hiện đề tài Nhóm nghiên cứu" form={form} onSubmit={() => { }} modalSize={"100%"}>
            <MyFlexRow>
