...
export default function F6_5_1_3UpdatecommitteeScoringSummary({ value }: { value: I6_5_1_3CommitteeScoringSummary }) {
    ...
    return (
        <MyActionIconUpdate form={form} onSubmit={() => { }} modalSize={"100%"}>
            ...
            <MyFlexRow>
                <MySelect label="Đề tài" data={['Chọn thành viên hội đồng nghiệm thu']} />
                <MySelect label="Hội đồng" data={['Chọn quyết định hội đồng nghiệm thu']} />
            </MyFlexRow>
