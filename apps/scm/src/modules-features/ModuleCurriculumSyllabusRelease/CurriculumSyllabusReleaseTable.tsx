...
export default function CurriculumSyllabusReleaseTable() {
    ...
    const columns = useMemo<MRT_ColumnDef<I_DocumentIssuance>[]>(() => [
        ...
        },
        {
            ...
            accessorFn: (row) => row.issuedDate ? U0DateToDDMMYYYString(new Date(row.issuedDate)) : ""
        },
        {
            header: 'Ngày có hiệu lực',
            accessorKey: 'effectiveDate',
            accessorFn: (row) => row.effectiveDate ? U0DateToDDMMYYYString(new Date(row.effectiveDate)) : ""
        },
        {
