...
const data = [
    { name: 'Đạt yêu cầu', value: 70, color: "#2a54a1" },
    { name: 'Yêu cầu hiệu chỉnh', value: 30, color: "#34b3e7" },
];

export function PieChartTechnicalEvaluationQuality() {
    return (
        <>
            <Text mb={"20"}>Kết quả thẩm định nội dung</Text>
            <Grid>
