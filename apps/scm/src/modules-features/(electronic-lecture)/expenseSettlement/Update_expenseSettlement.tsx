...
import { MyActionIcon, MyActionIconUpdate, MyDataTable, MyDateInput, MyFileInput, MySelect, MyTextArea, MyTextInput } from "aq-fe-framework/components";
import { MRT_ColumnDef } from "mantine-react-table";
import { useMemo } from "react";

export default function Update_expenseSettlement({ data }: { data: any }) {
        ...
        >
            <Tabs defaultValue="tab1" h={"55vh"}>
                ...
                <Tabs.Panel value="tab2">
                    <MyDataTable
                        columns={columns}
                        data={expenseSettlementQuery.data!}
                        enableRowSelection
