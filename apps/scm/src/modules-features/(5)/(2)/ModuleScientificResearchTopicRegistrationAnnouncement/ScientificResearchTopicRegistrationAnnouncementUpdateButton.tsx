...
import { MyActionIconUpdate, MyCheckbox, MyFlexColumn, MyFlexRow, MyTab, MyTextInput } from "aq-fe-framework/components";
...
export default function ScientificResearchTopicRegistrationAnnouncementButtonUpdate({
  values,
}: {
