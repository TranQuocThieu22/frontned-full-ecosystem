...
import { IStaffData } from "./ScientificResearchTopicRegistrationAnnouncementTab2";

export default function ScientificResearchTopicRegistrationAnnouncementTab2CreateButton() {
    const dis = useDisclosure();


    const ScientificResearchTopicRegistrationAnnouncementTab2CreateButton = useQuery<
        IStaffData[]
    >({
        queryKey: ["ScientificResearchTopicRegistrationAnnouncementTab2CreateButtonData"],
        queryFn: async () => {
    ...
    return (
        <MyButtonModal
            ...
            <MyDataTable
                isError={ScientificResearchTopicRegistrationAnnouncementTab2CreateButton.isError}
                isLoading={ScientificResearchTopicRegistrationAnnouncementTab2CreateButton.isLoading}
                exportAble={false}
                enableRowSelection={true}
                columns={staffColumns}
                data={ScientificResearchTopicRegistrationAnnouncementTab2CreateButton.data || []}
