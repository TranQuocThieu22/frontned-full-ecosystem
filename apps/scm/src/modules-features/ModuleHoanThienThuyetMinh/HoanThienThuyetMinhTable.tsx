...
import { IHoanThienThuyetMinhInfoViewModel } from "./interfaces/IHoanThienThuyetMinhInfoViewModel";

export default function HoanThienThuyetMinhTable() {
    const columns = useMemo<MRT_ColumnDef<IHoanThienThuyetMinhInfoViewModel>[]>(() => [
        ...
        {
            header: "Cập nhật file thuyết minh", accessorKey: "capNhatFileThuyetMinh",
            Cell: ({ row }) => {
                return (
                    <MyCenterFull>
...
const mockData: IHoanThienThuyetMinhInfoViewModel[] = [
    {
        id: 1,
