...
export default function F2_2Create() {
    ...
    return (
        <MyButtonCreate objectName="Văn bản quy định tổ chức" form={form} onSubmit={async (values) => {
            return await baseAxios.post("/Document/create",
                {
                    ...values,
                    DocumentType: C0DocumentTypes.Workflow,
            ...
            <F11_3Select label="Loại văn bản" documentTypeId={C0DocumentTypes.Workflow} {...form.getInputProps("documentAttributeId")} />
