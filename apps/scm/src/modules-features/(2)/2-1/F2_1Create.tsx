...
import F11_3Select from "@/modules-features/(11)/11-3/F11_3Select";
...
export default function F2_1Create() {
    ...
    return (
        <MyButtonCreate objectName="Văn bản quy định tổ chức" form={form} onSubmit={async (values) => {
            return await baseAxios.post("/Document/create",
                {
                    ...values,
                    DocumentType: C0DocumentTypes.Regulations,
            ...
            <F11_3Select label="Loại văn bản" documentTypeId={C0DocumentTypes.Regulations} {...form.getInputProps("documentAttributeId")} />
