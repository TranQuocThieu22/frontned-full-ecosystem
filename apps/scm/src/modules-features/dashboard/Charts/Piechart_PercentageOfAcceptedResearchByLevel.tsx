...
const data = [
    { name: 'Cấp Trường', value: 234, color: "#2a54a1" },
    { name: 'Cấp Tỉnh', value: 345, color: "#34b3e7" },
...
export function Piechart_PercentageOfAcceptedResearchByLevel() {

    // const totalDisountCode = mockData.reduce((acc, cur) => acc + cur.used, 0);

    return (
        <>
            <Text mb={"20"}>Biểu đồ tỷ lệ đề tài nghiệm thu theo cấp</Text>
            <Grid>
