...
import F9_8_7ButtonCheckListExchangeSession from "./F9_8_7ButtonCheckListExchangeSession";
...
export default function F9_8_2ReadExchangeSession() {
  const query = useQuery<IInfoViewModel[]>({
    queryKey: ['F9_8_2ReadExchangeSession'],
  ...
  return (
    <MyFieldset title="Danh sach lượt trao đổi">
      <MyDataTable
        ...
        renderRowActions={({ row }) => (
          <MyCenterFull>
            <F9_8_7ButtonCheckListExchangeSession />
          </MyCenterFull>
        )}
      />
    </MyFieldset>
