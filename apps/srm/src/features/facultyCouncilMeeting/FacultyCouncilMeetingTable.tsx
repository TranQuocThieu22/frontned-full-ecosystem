...
import FacultyCouncilMeetingExport from "./FacultyCouncilMeetingExport";
import FacultyCouncilMeetingUpdateButton from "./FacultyCouncilMeetingUpdateButton";

export default function FacultyCouncilMeetingTable() {
    ...
    const acceptanceContractQuery = useCustomReactQuery({
        queryKey: ['contract_list_faculty_council', academicStore.state.academicYear?.id],
    ...
    return (
        <>
            ...
            <FacultyCouncilMeetingUpdateButton disclosure={dics} acceptanceContract={dataUpdate} />
        </>
    );
}
