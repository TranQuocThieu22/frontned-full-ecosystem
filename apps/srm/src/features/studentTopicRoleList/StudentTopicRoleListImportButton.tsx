...
type ImportRow = SRMTitle & { isDeactivateValue?: number };
...
const fields: FieldOption<SRMTitle>[] = [
    ...
    { fieldKey: "isDeactivateValue", fieldName: "Không sử dụng", parseType: "number" },
...
export default function StudentTopicRoleListImportButton() {
    return (
        <CustomButtonImport
            fields={fields}
            fileName="Danh sách vai trò thực hiện đề tài sinh viên"
