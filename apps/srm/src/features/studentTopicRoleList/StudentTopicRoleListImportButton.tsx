...
export default function StudentTopicRoleListImportButton() {
  ...
  const handleExport = async () => {
    ...
    await excelUtils.addSheet<SRMTitle>({
      workbook: workbook,
      sheetName: "Danh sách vai trò thực hiện đề tài sinh viên",
      data: [],
      config: mainConfig,
    });

    await excelUtils.addSheet<I_IsDeactivateValueConfig>({
      workbook: workbook,
    ...
    excelUtils.download({
      name: "Danh sách vai trò thực hiện đề tài sinh viên",
      workbook,
    });
  };
