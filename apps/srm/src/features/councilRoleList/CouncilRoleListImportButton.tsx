...
export default function CouncilRoleListImportButton() {
    return (
        <CustomButtonImport
            fields={fields}
            fileName="Danh sách vai trò thực hiện hội đồng"
            ...
            onSubmit={(finalValues) => {
                const mapped: SRMTitle[] = finalValues.map((item) => ({
                    ...item,
                    type: 3,
