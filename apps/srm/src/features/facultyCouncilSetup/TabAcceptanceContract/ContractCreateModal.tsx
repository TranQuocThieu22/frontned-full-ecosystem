...
export default function ContractCreateModal({ acceptanceContractsData, handleAddAcceptanceContract }: Props) {
    ...
    const acceptanceContractQuery = useCustomReactQuery({
        ...
        axiosFn: () => {
            ...
            return acceptanceCouncilService.GetSRMContractAcceptance({ academicYearId: academicYearStore.state.academicYear?.id ?? -1, type: EnumAcceptanceCouncilType.Faculty });
        },
        options: {
