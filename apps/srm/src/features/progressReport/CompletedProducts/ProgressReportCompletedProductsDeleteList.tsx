...
export default function ProgressReportCompletedProductsDeleteList({ table }: { table: MRT_TableInstance<SRMCompletedProduct> }) {
            ...
            onSubmit={() => {
                ...
                return Promise.all(
                    selectedRows.map((row) =>
                        contractService.insertOrUpdateCompletedProduct({
                            id: row.id!,
