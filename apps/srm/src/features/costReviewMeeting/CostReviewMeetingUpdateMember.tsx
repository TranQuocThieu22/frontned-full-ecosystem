...
import CostReviewMeetingDeleteMember from "./CostReviewMeetingDeleteMember";
import CostReviewMeetingExportMember from "./CostReviewMeetingExportMember";

interface CostReviewMeetingUpdateMemberProps {
...
export default function CostReviewMeetingUpdateMember({
    topicDetail,
    members,
    criteriaSet,
    onChangeMembers,
    conclusions
}: CostReviewMeetingUpdateMemberProps) {
    ...
    const baseColumns: MRT_ColumnDef<SRMTopicMember>[] = useMemo(() => [
        {
    ...
    const renderTopToolbar = useCallback(({ table }: any) => {
        ...
        const membersToExport = selectedRows?.length > 0 ? selectedRows : topicDetail?.srmEvaluationCommittee?.srmEvaluationMembers ?? [];
        return <>
            <CostReviewMeetingExportMember
                members={membersToExport}
                criteriaSet={criteriaSet}
                topicMembers={members}
                conclusions={conclusions}
            />
            <CostReviewMeetingDeleteMember
                table={table}
