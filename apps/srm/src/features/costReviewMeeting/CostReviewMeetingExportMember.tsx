...
interface CostReviewMeetingExportMemberProps {
...
export default function CostReviewMeetingExportMember({ members, criteriaSet, topicMembers, conclusions }: CostReviewMeetingExportMemberProps) {
    const exportConfig = {
        fields: [
