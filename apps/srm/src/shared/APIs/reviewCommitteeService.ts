...
export const reviewCommitteeService = {
    ...
    getReviewCommitteeByAcademyYear: (params: { AcademicYearId?: number }) => {
        return axiosInstance.get<CustomApiResponse<SRMReviewCommittee[]>>(`${CONTROLLER}/GetReviewCommitteeByAcademicYear`, {
            params: params
        })
    },
    getReviewProposalByAcademyYear: (params: { AcademicYearId?: number, pageSize?: number, pageNumber?: number }) => {
        return axiosInstance.get<CustomApiResponse<SRMReviewProposal[]>>(`${CONTROLLER}/GetReviewProposalByAcademicYear`, {
            params: params
        })
    },
