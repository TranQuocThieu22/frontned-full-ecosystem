...
export default function F2_3Update({ values }: { values: I }) {
    ...
    return (
        <MyActionIconUpdate form={form} onSubmit={async (values) => {
            ...
            <F11_3Select label="Loại văn bản" documentTypeId={C0DocumentTypes.Form} {...form.getInputProps("documentAttributeId")} />
