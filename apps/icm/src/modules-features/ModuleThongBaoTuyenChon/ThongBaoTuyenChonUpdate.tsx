...
import { MyActionIconUpdate, MyCheckbox, MyDateInput, MyFileInput, MyTextEditor, MyTextInput } from "aq-fe-framework/components";
...
export default function ThongBaoTuyenChonUpdate({ values }: { values: ThongBaoTuyenChonViewModel }) {
