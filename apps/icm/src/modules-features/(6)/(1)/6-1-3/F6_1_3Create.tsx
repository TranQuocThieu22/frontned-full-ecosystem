...
import F6_1_3UpdateResearchGroup from "./F6_1_3UpdateResearchGroup";
import F6_1_3Delete from "./F6_1_3Delete";
import F6_1_3UpdateMember from "./F6_1_3UpdateMember";


export interface I6_1_3Create {
...
export interface I6_1_3ResearchGroup {
  id: number;
...
export default function F6_1_1Create() {
  const disc = useDisclosure(false)

  const form = useForm<I6_1_3Create>({
    initialValues: {
    },
  });
  ...
  return (
    <MyButtonModal
      ...
      modalSize={"90%"}
      disclosure={disc}
      title="Quyết định Thành lập hội đồng xét chọn nhóm nghiên cứu"
      onSubmit={() => {
      }}
    >
      <MyFlexRow justify={"space-evenly"}>
            <TextInput w={"100%"} label="Số quyết định:"></TextInput>
            <MyDateInput w={"100%"} label="Ngày quyết định:" placeholder="  /  /"></MyDateInput>
          </MyFlexRow>
          <TextInput label="Tên quyết định:"></TextInput>
      ...
      <MyDataTable
        ...
        renderRowActions={({ row }) => {
          return (
            <MyCenterFull>
              <F6_1_3UpdateMember values={row.original} />
      ...
      <MyDataTable
        ...
        renderRowActions={({ row }) => {
          return (
            <MyCenterFull>
              <F6_1_3UpdateResearchGroup values={row.original} />
              <F6_1_3Delete id={row.original.id!} />
            </MyCenterFull>
          );
        }}
...
const GroupData: I6_1_3ResearchGroup[] = [
  {
    id: 1,
