...
export default function F6_3_1_3UpdateSummaryOfScoringResults({ values }: { values: I6_3_1_3SummaryOfScoringResults }) {
    ...
    return (
        <MyActionIconUpdate form={form} onSubmit={() => { }} modalSize={"100%"}>
            ...
            >
                ...
                <MySelect label="Trưởng ban kiểm phiếu" data={['Chọn quyết định hội đồng xét duyệt đề tài nhóm nghiên cứu']} style={{ width: "50%" }} />
            </Flex>
