...
export default function FeatViewGroupProjectDistributionChart() {
    const data = [
    ...
    return (
        <>
            ...
            <Text fz="xs" mb="50" ta="center">
                Biểu đồ phân bố cấp đề tài giảng
            </Text>
            ...
            {/* Chú thích tự tạo */}
            <Box mt="md" ta="center">
                <Group justify="center"> {/* Thay đổi từ mặc định sang justify="flex-end" */}
