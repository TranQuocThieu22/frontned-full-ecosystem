...
import { MyActionIconUpdate, MyDateInput, MySelect } from "aq-fe-framework/components";
import { I_InteractionTable } from "./PartnerTable";
export default function PartnerUpdate({ values }: { values: I_InteractionTable }) {
    const form = useForm<I_InteractionTable>({
        initialValues: values
    })
    return (
        <MyActionIconUpdate modalSize="70%" title="Chi tiết tương tác" form={form} onSubmit={() => { }} >
