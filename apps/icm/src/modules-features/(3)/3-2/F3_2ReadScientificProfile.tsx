...
import F3_2ButtonUpdateScientificProfile from "./F3_2ButtonUpdateScientificProfile";
import F3_2PrintScientifictProfile from "./F3_2PrintScientifictProfile";
...
export default function F3_2ReadScientificProfile() {
