...
import { MyActionIconUpdate, MyActionIconUpload, MyTextArea } from "aq-fe-framework/components";
import { useMemo } from "react";
import { IRelatedDocuments } from "./interface/RelatedDocumentsViewModel";
import { sampleData } from "./RelatedDocumentsTable";

export default function ExchangeProgramRoleButtonUpdate({
  values,
}: {
  values: IRelatedDocuments;
}) {
