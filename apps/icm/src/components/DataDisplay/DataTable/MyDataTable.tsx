...
export function MyDataTable<TData extends MRT_RowData>(
    { formats = {}, exportAble = true, csvConfigProps, rowActionSize, columns, data, renderTopToolbarCustomActions, setSelectedRow, ...rest }: IDataTable<TData>) {
    ...
    useEffect(() => {
        setSelectedRow && setSelectedRow(table.getSelectedRowModel().rows.map((row) => row.original.id));
