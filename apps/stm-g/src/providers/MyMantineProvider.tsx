'use client'
import { ActionIcon, Blockquote, Divider, Indicator, MantineProvider, Modal, Overlay, Paper, Select, SimpleGrid, Space, Switch, Table, TextInput, Textarea, Title, Tooltip, createTheme } from '@mantine/core';
