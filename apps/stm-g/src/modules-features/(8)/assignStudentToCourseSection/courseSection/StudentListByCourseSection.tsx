...
import DeleteStudentFromCourseSection from './DeleteStudentFromCourseSection';
...
export default function StudentListByCourseSection({ label, values, color }: IBase) {
    const disc = useDisclosure()

    const danhSachLop = useQuery<IEnrollment[]>({
        queryKey: [`F8_1StudentListByClass`, values],
        queryFn: async () => {
            const body =
            {
                    ...
                    renderRowActions={({ row }) => {
                        ...
                        return (
                            <MyCenterFull>
                                ...
                                <DeleteStudentFromCourseSection data={row.original} />
