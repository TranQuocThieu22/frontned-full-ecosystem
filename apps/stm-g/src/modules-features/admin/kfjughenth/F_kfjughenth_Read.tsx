...
import F_kfjughenth_Update from "./F_kfjughenth_Update";
import { mockDataRead } from "./mockDataRead";




export interface Ikfjughenth {
...
export default function F_kfjughenth_Read() {
    const query = useQuery<Ikfjughenth[]>({
        queryKey: [`F_kfjughenth_Read`],
    ...
    const columns = useMemo<MRT_ColumnDef<Ikfjughenth>[]>(
        () => [
            {
                header: "Mã học viên",
            ...
            {
                header: "Thao tác",
                Cell: ({ cell }) => <F_kfjughenth_Update data={cell.row.original} />,
            },
            {
