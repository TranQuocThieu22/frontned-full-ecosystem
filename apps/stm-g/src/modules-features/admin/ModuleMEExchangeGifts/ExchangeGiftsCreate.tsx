...
import { MyButtonCreate, MySelect } from "aq-fe-framework/components";
import { useMemo } from "react";
import { IGiftItem, IStudent } from "./ExchangeGiftsLayout";

export default function ExchangeGiftsCreate() {
    const form = useForm({
        initialValues: {
            studentCode: "",
            gift: {
                ...
                inputContainer={(children) => (
                    <SimpleGrid cols={2} spacing="md">
                        ...
                        <Group gap={6}>
                            ...
                            <Text color="red" fw={500}> {gift?.sticker || 0}</Text>
                        </Group>
                    </SimpleGrid>
                )}
            />
