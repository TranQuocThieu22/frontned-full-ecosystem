...
import { IconCreditCardPay, IconPrinter } from "@tabler/icons-react";
...
export default function F_jzmczvppf6_ThuBoSung({ values }: { values: IStudentInfo }) {
    ...
    return (
        ...
        >
            ...
            <MyTextInput label="Nội dung thu" />
            <MyFlexRow justify="flex-end">
                <MyButton crudType="save" bg="green">Lưu</MyButton>
                <MyButton crudType="save" leftSection={<IconPrinter />} bg="green">Lưu và In phiếu thu</MyButton>
            </MyFlexRow>
        </MyButtonModal>
    )
}
