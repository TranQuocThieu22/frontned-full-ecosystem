...
import { ICertificateDecisionViewModelWithFile, ICertificateInfoViewModel } from './Interfaces/Interfaces'
...
export default function CertificateDecisionCreateButton() {
    ...
    const handleRemoveCertificateResultSelection = (row: ICertificateResult) => {
        ...
        console.log(MRTSelectCertificateResult.getState().rowSelection);
