...
import { DisplayQualityReviewStatus, DisplayQualityReviewStatusMap } from "../MELessonReviewsApproval/DisplayQualityReviewStatus";
...
export default function LessonReviewsTable() {
    ...
    const columns = useMemo<MRT_ColumnDef<IClassInfo>[]>(
        () => [
            ...
            { accessorKey: 'studentCount', header: 'Sĩ số hiện tại/ Sĩ số tối đa' },
            {
                ...
                size: 200,
                Cell: ({ row }) => <DisplayClassStatus classStatus={DisplayClassStatusMap[row.original.classStatus] ?? -1} />
            },
            {
            ...
            },
            {
                ...
                size: 200,
                Cell: ({ row }) => <DisplayQualityReviewStatus statuss={DisplayQualityReviewStatusMap[row.original.qualityApproved] ?? -1} />
            },
        ], []
    );
