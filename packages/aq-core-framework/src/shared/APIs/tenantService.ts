...
import type { Tenant } from "@aq-fe/aq-core-framework/shared/interfaces/Tenant";
import { createBaseAPI, PagingParams } from "@aq-fe/aq-core-framework/shared/libs/createBaseAPI";
