...
import { CustomColumnDef, CustomDataTable, PaginationState } from "@aq-fe/aq-legacy-framework/shared/components/dataDisplay/CustomDataTable";
import { CustomThemeIconSquareCheck } from "@aq-fe/aq-legacy-framework/shared/components/dataDisplay/CustomThemeIconSquareCheck";
...
export function DepartmentFeature() {
    ...
    const departmentQuery = useLegacyReactQuery({
