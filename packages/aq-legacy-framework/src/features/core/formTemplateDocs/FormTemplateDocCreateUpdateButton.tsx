...
import { FormTemplateDocTypeSelect } from "./FormTemplateDocTypeSelect";

export interface FormTemplateDocCreateUpdateButtonProps {
...
export function FormTemplateDocCreateUpdateButton({
	documentType,
	documentAttributeId,
	values,
	documentAttributeQuery
}: FormTemplateDocCreateUpdateButtonProps) {
