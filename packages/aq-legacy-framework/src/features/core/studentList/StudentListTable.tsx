'use client'
import StudentListCreateUpdate from "@aq-fe/aq-legacy-framework/features/core/studentList/StudentListCreateUpdate";
...
import { CustomColumnDef, PaginationState } from "@aq-fe/aq-legacy-framework/shared/components/dataDisplay/CustomDataTable";
...
export default function StudentListTable() {
    ...
    const studentQuery = useLegacyReactQuery({
