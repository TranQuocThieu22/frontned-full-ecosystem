...
import { StudentActivityPlan, studentActivityPlanStatusEnum, studentActivityPlanStatusLabel } from "@aq-fe/aq-legacy-framework/shared/interfaces/StudentActivityPlan";
