...
import CorePermissionCheck, { Permission } from "@aq-fe/aq-legacy-framework/shared/components/input/CorePermissionCheck";
...
export default function Permission_ViewCheckMenuPermission({
    ...
    const rolePermissionQuery = useLegacyReactQuery<Role[]>({
