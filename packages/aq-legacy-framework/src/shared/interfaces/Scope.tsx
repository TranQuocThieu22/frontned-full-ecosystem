import { ScopeLevel, ScopeLevelColor, ScopeLevelLabel, ScopeStatusColor, ScopeStatusEnum, ScopeStatusLabel } from "@aq-fe/aq-legacy-framework/shared/const/enum/EnumScopeStatus"
