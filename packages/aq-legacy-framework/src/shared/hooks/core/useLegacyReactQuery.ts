...
export function useLegacyReactQuery<IRes, IBody = unknown, TData = IRes>({
    queryKey,
    axiosFn,
    options,
    mockData,
    ...
    } as unknown as UseQueryResult<TData, Error> & { dataCount: number; rawData: CustomApiResponse<IRes> | null };
}
