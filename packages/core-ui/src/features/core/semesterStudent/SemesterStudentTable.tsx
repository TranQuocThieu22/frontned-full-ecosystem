"use client"
import { accountService, ImportStudentActivityPlan } from "@aq-fe/core-ui/shared/APIs/accountService"
...
import { StudentActivityPlan, studentActivityPlanStatusLabel } from "@aq-fe/core-ui/shared/interfaces/StudentActivityPlan"
...
export default function SemesterStudentTable() {
    ...
    const semesterStudentQuery = useCustomReactQuery({
