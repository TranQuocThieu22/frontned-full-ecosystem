...
import { cn } from "@aq-fe/core-ui/shared/libs/tailwind/cn";
...
export function CustomBoxesBackground({ title, desc = "Được phát triển bởi công ty công nghệ Anh Quân." }: { title: string, desc?: string }) {
    return (
