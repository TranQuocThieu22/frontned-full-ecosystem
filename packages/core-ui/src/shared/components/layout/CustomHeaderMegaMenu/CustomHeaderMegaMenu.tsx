...
import { useHeaderMegaMenuStore } from './useHeaderMegaMenuStore';
...
interface CustomHeaderMegaMenuProps {
    children?: ReactNode
    menus?: IMenu[]
}

export function CustomHeaderMegaMenu({ children, menus }: CustomHeaderMegaMenuProps) {
    ...
    return (
        <Box>
            ...
            <Container fluid pt={'sm'} pb={'md'} bg={colorsObject.mantineBackgroundSecondary} mih={'93vh'}>
                {children}
            </Container>
            <Drawer
                opened={drawerOpened}
