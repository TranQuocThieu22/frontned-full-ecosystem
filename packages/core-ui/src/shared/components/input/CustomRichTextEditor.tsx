...
interface CustomRichTextEditorProps extends Omit<InputWrapperProps, "value" | "onChange" | "onBlur"> {
    value?: string;
        ...
        <Input.Wrapper  {...inputWrapperProps} {...rest}>
            ...
            >
                ...
                <ScrollArea.Autosize
                    ...
                    className={`min-h-[130px] ${editor?.isEditable ? '' : 'bg-gray-100 text-gray-500 cursor-default'}`}
                    mah={"130"}
                    style={{
