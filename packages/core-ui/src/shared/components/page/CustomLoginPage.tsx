...
export interface CustomLoginCredentials {
    username: string;
    password: string;
    rememberMe: boolean;
}

export interface CustomLoginPageProps {
    ...
    subtitle?: string;
    header?: ReactNode;
    onSubmit?: (credentials: CustomLoginCredentials) => void | Promise<void>;
...
export function CustomLoginPage({
    ...
    async function handleSubmit(values: typeof form.values) {
        const credentials: CustomLoginCredentials = {
