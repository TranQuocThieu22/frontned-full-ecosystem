...
interface CustomHtmlWrapperProps extends TypographyStylesProviderProps {
    html: string;
    mah?: number | string;
    zip?: boolean
}

export function CustomHtmlWrapper({ html, mah, zip = false, ...rest }: CustomHtmlWrapperProps) {
