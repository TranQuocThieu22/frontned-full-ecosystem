import { SyncBatchLogStatusEnum } from '@aq-fe/core-ui/shared/consts/enum/syncBatchLogStatusEnum';
import { SyncLogStepEnum } from '@aq-fe/core-ui/shared/consts/enum/syncLogStepEnum';
...
import { AQDataSynchronizationService } from '../../APIs/AQDataSynchronizationService';
import { messageIncludesType, removeSyncMessagePrefix, SyncMessageEnum } from '../../consts/enum/syncMessageEnum';
...
import CustomSyncStepper from '../dataDisplay/CustomSyncStepper';
...
export default function CustomButtonModalProcessSync({
    ...
    const startSyncMutation = useCustomReactMutation<void, SyncBatchLog>({
        axiosFn,
