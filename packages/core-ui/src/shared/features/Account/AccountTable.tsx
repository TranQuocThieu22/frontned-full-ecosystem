...
import { CustomDataTableAPI, CustomDataTableAPIProps } from "@aq-fe/core-ui/shared/components/withAPI/CustomDataTableAPI";
...
export default function AccountTable({
    ...
    const adminAccountQuery = useCustomReactQuery({
